...
export async function getProgramLearning(
  sessionId: string,
  studentId: string,
) {
  const [sessionAssignments, sessionSurveys] = await Promise.all([
