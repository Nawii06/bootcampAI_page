...
interface Participation { id: string; participationType: string; title: string; createdAt: string }
interface Response {
  company: { id: string; name: string; companyType: string };
  data: Participation[];
}
...
export default function PartnerDashboard() {
  const activities = useQuery({
    ...
    queryFn: () => customFetch<Response>("/api/v1/company-participations", {
