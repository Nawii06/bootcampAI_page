...
interface Participation { id: string; title: string; details: { requiredSkills?: string[]; projectTopics?: string[] }; createdAt: string }
...
export default function PartnerSurvey() {
  ...
  const surveys = useQuery({
    ...
    queryFn: () => customFetch<{ data: Participation[] }>(`/api/v1/company-participations?businessYearId=${yearId}&participationType=DEMAND_SURVEY`, { responseType: "json", credentials: "include" }),
  });
