...
interface Project { id: string; title: string; details: { track?: string; problemDefinition?: string; dataTypes?: string[]; expectedOutputs?: string[] }; createdAt: string }
...
export default function PartnerProject() {
  ...
  const projects = useQuery({
    ...
    queryFn: () => customFetch<{ data: Project[] }>(`/api/v1/company-participations?businessYearId=${yearId}&participationType=PROJECT`, { responseType: "json", credentials: "include" }),
  });
