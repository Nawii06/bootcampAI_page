...
interface Target { id: string; indicatorId: string; targetValue: string; version: string; rationale?: string }
interface Overview { indicators: Indicator[]; targets: Target[]; results: unknown[] }
