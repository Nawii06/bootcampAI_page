...
interface Target { indicatorId: string; targetValue: string; version: string }
interface Result { indicatorId: string; actualValue: string; status: string }
...
export default function AdminPerformanceExport() {
  ...
  const overview = useQuery({
    ...
    queryFn: () => customFetch<Overview>(`/api/v1/performance/overview?businessYearId=${year!.id}`, {
