...
export default function Home() {
  const programs = useQuery({
    ...
    queryFn: () => contractFetch(ProgramListResponseSchema, "/api/v1/programs?status=OPEN"),
  });
  const companies = useQuery({
    queryKey: ["public", "home", "companies"],
    queryFn: () => contractFetch(PublicCompanyListResponseSchema, "/api/v1/public/companies"),
  });
  const results = useQuery({
    queryKey: ["public", "home", "results"],
    queryFn: () => contractFetch(PublicPerformanceResultListResponseSchema, "/api/v1/public/performance-results"),
  });
  return (
    <Layout>
