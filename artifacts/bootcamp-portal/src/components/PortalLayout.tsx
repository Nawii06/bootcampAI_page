...
export function PortalLayout({ children }: PortalLayoutProps) {
  ...
  const menuItems = {
    ...
    admin: [
      ...
      { label: "성과관리 대시보드", path: "/admin/performance" },
      { label: "성과지표 목표", path: "/admin/performance/indicators" },
      { label: "연차별 실적", path: "/admin/performance/results" },
      { label: "성과 증빙자료", path: "/admin/performance/evidence" },
      { label: "연동 기초데이터", path: "/admin/performance/source-data" },
      { label: "Excel 다운로드", path: "/admin/performance/export" },
